#!/usr/bin/env python3
"""PostToolUse hook for automatic progress logging and checkpoint suggestions.

This hook runs after Edit, Write, and Bash tools to:
1. Detect significant changes
2. Auto-log progress entries
3. Suggest checkpoints after major changes
4. Track cumulative changes for checkpoint timing
5. Parse test results and suggest feature status updates
"""
...
try:
    ...
    def load_config(work_dir=None):
        return {"auto_progress_logging": True, "auto_checkpoint_suggestions": True}
